...
//=========  (Mon Jun 23 15:13:56 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(88,150,24.99928938);
   graph->SetPoint(89,150.0007106,25);
   graph->SetPoint(90,150,30.85975925);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Graph",100,86.96474,843.3879);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_obs_p172438 = new TH1F("Graph_Graph_Graph_g_excl_xsec_obs_p172438","g_excl_xsec_obs_p1",100,87.75831,834.6586);
