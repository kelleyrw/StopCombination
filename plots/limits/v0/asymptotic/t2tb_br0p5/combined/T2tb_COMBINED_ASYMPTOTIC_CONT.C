...
//=========  (Mon Jun 23 15:13:56 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(0,150,26.93027459);
   graph->SetPoint(1,150.0002779,25);
   graph->SetPoint(2,150,24.99972213);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   graph->SetPoint(6,245.9734834,0);
   graph->SetPoint(7,250,3.580303992);
   graph->SetPoint(8,263.5005008,25);
   graph->SetPoint(9,275,38.06392925);
   graph->SetPoint(10,283.5017883,50);
   graph->SetPoint(11,300,70.62128919);
   graph->SetPoint(12,305.0399598,75);
   graph->SetPoint(13,325,92.47331535);
   graph->SetPoint(14,332.9661949,100);
   graph->SetPoint(15,350,110.9362007);
   graph->SetPoint(16,366.1607112,125);
   graph->SetPoint(17,375,131.3662329);
   graph->SetPoint(18,400,147.9389101);
   graph->SetPoint(19,403.8578531,150);
   graph->SetPoint(20,425,158.7274035);
   graph->SetPoint(21,450,174.4338799);
   graph->SetPoint(22,450.8529383,175);
   graph->SetPoint(23,475,189.2577462);
   graph->SetPoint(24,493.5617868,200);
   graph->SetPoint(25,500,202.2852879);
   graph->SetPoint(26,525,207.2079628);
   graph->SetPoint(27,550,212.7783304);
   graph->SetPoint(28,575,218.8416926);
   graph->SetPoint(29,600,213.6616192);
   graph->SetPoint(30,625,204.8078131);
   graph->SetPoint(31,639.6424529,200);
   graph->SetPoint(32,650,195.2690187);
   graph->SetPoint(33,675,189.4351601);
   graph->SetPoint(34,698.3159112,175);
   graph->SetPoint(35,700,173.3401756);
   graph->SetPoint(36,719.1049708,150);
   graph->SetPoint(37,725,137.4827406);
   graph->SetPoint(38,729.7930289,125);
   graph->SetPoint(39,735.3494107,100);
   graph->SetPoint(40,729.7548035,75);
   graph->SetPoint(41,725,67.07565957);
   graph->SetPoint(42,714.6750673,50);
   graph->SetPoint(43,700,31.19474192);
   graph->SetPoint(44,694.8636181,25);
   graph->SetPoint(45,678.0025917,0);
   graph->SetPoint(46,1300,-1300);
   ...
   graph->SetLineStyle(7);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,30.85975925);
   graph->SetPoint(1,150.0007106,25);
   graph->SetPoint(2,150,24.99928938);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_exp_m1522 = new TH1F("Graph_Graph_g_excl_xsec_exp_m1522","g_excl_xsec_exp_m1",100,86.96474,843.3879);
   ...
   graph->SetFillColor(1);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,29.63903221);
   graph->SetPoint(1,150.0005777,25);
   graph->SetPoint(2,150,24.99942229);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_obs_p1724 = new TH1F("Graph_Graph_g_excl_xsec_obs_p1724","g_excl_xsec_obs_p1",100,87.75831,834.6586);
