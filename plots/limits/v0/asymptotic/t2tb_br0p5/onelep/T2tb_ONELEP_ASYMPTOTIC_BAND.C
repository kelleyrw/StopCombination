...
//=========  (Mon Jun 23 15:13:52 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(21,150,24.99947363);
   graph->SetPoint(22,150.0005264,25);
   graph->SetPoint(23,150,29.43224262);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Graph",100,117.16,511.2402);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_obs_p162236 = new TH1F("Graph_Graph_Graph_g_excl_xsec_obs_p162236","g_excl_xsec_obs_p1",100,114.5959,539.4455);
