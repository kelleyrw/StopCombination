...
//=========  (Mon Jun 23 15:13:52 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(0,150,26.50135393);
   graph->SetPoint(1,150.0002124,25);
   graph->SetPoint(2,150,24.99978764);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   graph->SetPoint(6,271.8456259,0);
   graph->SetPoint(7,275,11.14007284);
   graph->SetPoint(8,278.8155289,25);
   graph->SetPoint(9,297.4920511,50);
   graph->SetPoint(10,300,52.37211401);
   graph->SetPoint(11,324.4543157,75);
   graph->SetPoint(12,325,75.4114807);
   graph->SetPoint(13,350,92.08680103);
   graph->SetPoint(14,362.4532978,100);
   graph->SetPoint(15,375,107.431087);
   graph->SetPoint(16,400,115.3912673);
   graph->SetPoint(17,425,111.5222973);
   graph->SetPoint(18,443.7393679,100);
   graph->SetPoint(19,450,95.11910938);
   graph->SetPoint(20,469.4580269,75);
   graph->SetPoint(21,475,63.52850344);
   graph->SetPoint(22,480.1064889,50);
   graph->SetPoint(23,480.9341579,25);
   graph->SetPoint(24,475,10.63032329);
   graph->SetPoint(25,469.664086,0);
   ...
   graph->SetLineStyle(7);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,29.43224262);
   graph->SetPoint(1,150.0005264,25);
   graph->SetPoint(2,150,24.99947363);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_exp_m1420 = new TH1F("Graph_Graph_g_excl_xsec_exp_m1420","g_excl_xsec_exp_m1",100,117.16,511.2402);
   ...
   graph->SetFillColor(1);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,29.25818172);
   graph->SetPoint(1,150.000521,25);
   graph->SetPoint(2,150,24.99947896);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_obs_p1622 = new TH1F("Graph_Graph_g_excl_xsec_obs_p1622","g_excl_xsec_obs_p1",100,114.5959,539.4455);
