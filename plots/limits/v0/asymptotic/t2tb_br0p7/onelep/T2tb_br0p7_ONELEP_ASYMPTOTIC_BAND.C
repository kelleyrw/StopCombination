...
//=========  (Sun Jun 29 21:55:44 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(22,588.0078588,0);
   graph->SetPoint(23,593.66052,25);
   graph->SetPoint(24,593.8971472,50);
   graph->SetPoint(25,588.9074237,75);
   graph->SetPoint(26,580.7670956,100);
   graph->SetPoint(27,575,112.6277164);
   graph->SetPoint(28,567.5459676,125);
   graph->SetPoint(29,550,145.4303419);
   graph->SetPoint(30,545.8625816,150);
   graph->SetPoint(31,525,168.4933416);
   graph->SetPoint(32,502.6685047,175);
   graph->SetPoint(33,500,175.3750457);
   graph->SetPoint(34,495.1305402,175);
   graph->SetPoint(35,475,173.0053016);
   graph->SetPoint(36,450,168.3281832);
   graph->SetPoint(37,425,161.0457357);
   graph->SetPoint(38,400,152.5184466);
   graph->SetPoint(39,394.1905012,150);
   graph->SetPoint(40,375,139.7704328);
   graph->SetPoint(41,350,127.7523257);
   graph->SetPoint(42,344.574329,125);
   graph->SetPoint(43,325,112.5333891);
   graph->SetPoint(44,301.5329635,100);
   graph->SetPoint(45,300,98.9318526);
   graph->SetPoint(46,275,75.00034143);
   graph->SetPoint(47,274.9996586,75);
   graph->SetPoint(48,250,50.00052595);
   graph->SetPoint(49,249.999474,50);
   graph->SetPoint(50,225,25.00058147);
   graph->SetPoint(51,224.9994185,25);
   graph->SetPoint(52,200,0.001016892626);
   graph->SetPoint(53,199.9989831,0);
   graph->SetPoint(54,200,-12.5);
   graph->SetPoint(55,175,-12.5);
   graph->SetPoint(56,150,-12.5);
   graph->SetPoint(57,150.2191593,0);
   graph->SetPoint(58,175,24.74360527);
   graph->SetPoint(59,175.1285613,25);
   graph->SetPoint(60,200,49.86879499);
   graph->SetPoint(61,200.0700616,50);
   graph->SetPoint(62,225,74.93915473);
   graph->SetPoint(63,225.0342002,75);
   graph->SetPoint(64,250,99.97966792);
   graph->SetPoint(65,250.0119437,100);
   graph->SetPoint(66,275,124.9948085);
   graph->SetPoint(67,275.0031595,125);
   graph->SetPoint(68,275,133.6068099);
   graph->SetPoint(69,250,126.0199884);
   graph->SetPoint(70,246.5615799,125);
   graph->SetPoint(71,225,109.8541756);
   graph->SetPoint(72,213.0254702,100);
   graph->SetPoint(73,200,89.53772964);
   graph->SetPoint(74,189.9068485,75);
   graph->SetPoint(75,175,60.52584371);
   graph->SetPoint(76,150,50.03294721);
   graph->SetPoint(77,149.9670528,50);
   graph->SetPoint(78,131.0836459,25);
   graph->SetPoint(79,125,18.40513674);
   graph->SetPoint(80,100,0.3764010862);
   
   TH1F *Graph_Graph36 = new TH1F("Graph_Graph36","Graph",100,50.61029,643.2869);
   Graph_Graph36->SetMinimum(-31.2875);
   Graph_Graph36->SetMaximum(194.1626);
   ...
   Graph_Graph_Graph_g_excl_xsec_obs192337->SetMinimum(-1448.749);
   Graph_Graph_Graph_g_excl_xsec_obs192337->SetMaximum(336.2339);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_obs_p172438 = new TH1F("Graph_Graph_Graph_g_excl_xsec_obs_p172438","g_excl_xsec_obs_p1",100,51.56572,632.7771);
   Graph_Graph_Graph_g_excl_xsec_obs_p172438->SetMinimum(-34.05851);
   Graph_Graph_Graph_g_excl_xsec_obs_p172438->SetMaximum(224.6436);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_obs_m182539 = new TH1F("Graph_Graph_Graph_g_excl_xsec_obs_m182539","g_excl_xsec_obs_m1",100,55.431,590.259);
   Graph_Graph_Graph_g_excl_xsec_obs_m182539->SetMinimum(-31.1013);
   Graph_Graph_Graph_g_excl_xsec_obs_m182539->SetMaximum(192.1143);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_exp32040 = new TH1F("Graph_Graph_Graph_g_excl_xsec_exp32040","g_excl_xsec_exp",100,57.04691,572.484);
   Graph_Graph_Graph_g_excl_xsec_exp32040->SetMinimum(-26.94444);
   Graph_Graph_Graph_g_excl_xsec_exp32040->SetMaximum(146.3888);
