...
//=========  (Mon Jun 23 15:15:14 2014) by ROOT version5.34/03
   ...
   graph->SetPoint(18,150,24.99954317);
   graph->SetPoint(19,150.0004568,25);
   graph->SetPoint(20,150,28.66547515);
   
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Graph",100,120.0279,479.6927);
   ...
   TH1F *Graph_Graph_Graph_g_excl_xsec_obs_p162236 = new TH1F("Graph_Graph_Graph_g_excl_xsec_obs_p162236","g_excl_xsec_obs_p1",100,116.3172,520.5111);
