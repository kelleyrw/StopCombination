...
//=========  (Mon Jun 23 15:15:14 2014) by ROOT version5.34/03
   ...
   TH2D *h_ul_xsec_exp_smoothEMPTY = new TH2D("h_ul_xsec_exp_smoothEMPTY","Expected onelep #sigma #times Branching Fraction (t2tb_br0p5)EMPTY",31,137.5,912.5,29,-12.5,712.5);
   ...
   graph->SetPoint(0,150,26.99778003);
   graph->SetPoint(1,150.0003019,25);
   graph->SetPoint(2,150,24.99969812);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   graph->SetPoint(6,273.8725177,0);
   graph->SetPoint(7,275,4.548767285);
   graph->SetPoint(8,279.8086649,25);
   graph->SetPoint(9,297.9591708,50);
   graph->SetPoint(10,300,51.81954853);
   graph->SetPoint(11,325,71.28471382);
   graph->SetPoint(12,330.3876579,75);
   graph->SetPoint(13,350,85.96623566);
   graph->SetPoint(14,371.4428884,100);
   graph->SetPoint(15,375,101.9519114);
   graph->SetPoint(16,400,104.3788675);
   graph->SetPoint(17,411.7250993,100);
   graph->SetPoint(18,425,85.69683599);
   graph->SetPoint(19,438.6853516,75);
   graph->SetPoint(20,450,58.11671217);
   graph->SetPoint(21,454.3288418,50);
   graph->SetPoint(22,454.1717231,25);
   graph->SetPoint(23,450,17.44376226);
   graph->SetPoint(24,440.2184984,0);
   graph->SetPoint(25,1300,-1300);
   graph->SetPoint(26,-1300,-1300);
   ...
   graph->SetLineStyle(7);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,28.66547515);
   graph->SetPoint(1,150.0004568,25);
   graph->SetPoint(2,150,24.99954317);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_exp_m1420 = new TH1F("Graph_Graph_g_excl_xsec_exp_m1420","g_excl_xsec_exp_m1",100,120.0279,479.6927);
   ...
   graph->SetFillColor(1);
   graph->SetLineWidth(2);
   graph->SetPoint(0,150,29.57826954);
   graph->SetPoint(1,150.0005985,25);
   graph->SetPoint(2,150,24.99940152);
   graph->SetPoint(3,150,-12.5);
   graph->SetPoint(4,175,-12.5);
   graph->SetPoint(5,200,-12.5);
   ...
   TH1F *Graph_Graph_g_excl_xsec_obs_p1622 = new TH1F("Graph_Graph_g_excl_xsec_obs_p1622","g_excl_xsec_obs_p1",100,116.3172,520.5111);
